...
$routes->get('/dataJadwalSidangPidum', 'Publik::getDataJadwalSidangPidum');
...
$routes->get('/jadwal-sidang-pidum', 'Publik::jadwalSidangPidum');
$routes->get('/cms-perkara-pidum', 'Publik::cmsPidum');
